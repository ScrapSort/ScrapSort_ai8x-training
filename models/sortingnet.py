...
class SimpleSortingClassifierBN128(nn.Module):
    def __init__(self, num_classes=5, num_channels=3, dimensions=(128, 128), bias=False, **kwargs):
        ...
        self.fc2 = ai8x.Linear(128, 5, bias=True, wide=True, **kwargs)
...
class SimpleSortingClassifierBNBB128(nn.Module):
    def __init__(self, num_classes=5, num_channels=3, dimensions=(128, 128), bias=False, **kwargs):
        ...
        pretrained_path = "/home/geffen_cooper/ScrapSort/ScrapSort_ai8x-training/simplesort9_qat.pth.tar"
        ...
        self.feature_extractor.fc2 = ai8x.Linear(128, 11, bias=True, wide=True, **kwargs)
